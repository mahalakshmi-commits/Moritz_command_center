import svgPaths from "./svg-k8lucqgk2k";
...
import { imgImage12 } from "./svg-o8fht";
...
export default function Frame97() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[12px] items-start py-[12px] relative rounded-[8px] size-full">

import svgPaths from "./svg-hrytw8zu88";
...
import imgImage19 from "./c8929df55fea6dd9303f6b534c947d5e2309083f.png";
import { imgImage12 } from "./svg-4l2zd";
type SeparatorProps = {
  className?: string;
  direction?: "Vertical";
  spacing?: "None";
...
function Frame15() {
  return (
    <div className="bg-white col-1 content-stretch flex flex-col gap-[3px] items-start ml-0 mt-0 relative rounded-tl-[8px] rounded-tr-[8px] row-1 w-[101px]">
      <Frame14 />
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <p className="[word-break:break-word] col-1 font-['SF_Pro:Regular',sans-serif] font-normal leading-[26.4px] ml-[115px] mt-[6px] relative row-1 text-[#a3a3a3] text-[14px] tracking-[-0.5px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        Finance
      </p>
      <div className="col-1 h-0 ml-px mt-[39.5px] relative row-1 w-[1144.5px]">
    ...
    <div className="bg-white h-[72px] relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center p-[16px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[#181d27] text-[14px] whitespace-nowrap">Transcript Review</p>
        </div>
      </div>
    </div>
  );
...
function Frame135() {
  return (
    <div className="bg-[#e5e5e5] h-[448px] relative rounded-[10px] shrink-0 w-full">
...
function Frame18() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[12px] items-start left-[256px] px-[12px] py-[8px] rounded-[9px] top-[249px] w-[1152px]">
      <Frame16 />
      <Frame137 />
    </div>
  );
...
function Frame154() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0">
      <p className="[word-break:break-word] font-['SF_Pro:Medium',sans-serif] font-[510] leading-[1.4] relative shrink-0 text-[#525252] text-[12px] w-[500px]" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Frame139() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[12px] items-start left-[256px] p-[16px] rounded-[8px] top-[1012px] w-[568px]">
      <Frame140 />
      <Frame142 />
      <Frame119 />
      <Frame138 />
...
export default function Desktop() {
  return (
    <div className="bg-[#f5f5f5] relative size-full" data-name="Desktop - 1">
      <SidebarWithChildren />
      <Frame3 />
      <Frame6 />
      <Frame18 />
      <Frame139 />
      <div className="absolute h-[197px] left-[830px] top-[1017px] w-[528px]" data-name="image 13">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[176.79%] left-0 max-w-none top-0 w-full" src={imgImage19} />
        </div>
      </div>
    </div>
  );
